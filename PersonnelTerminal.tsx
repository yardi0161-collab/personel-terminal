...
import { fetchDiscordGuildRoles, mapRolesToPangkatDivisi } from "@/lib/discord";
...
export default function PersonnelTerminal() {
  ...
  const syncFromSession = async (session: Session | null) => {
    ...
    // Tampilkan nama & foto dulu, pangkat/devisi menyusul setelah role terbaca
  ...
  useEffect(() => {
    ...
    // Sengaja TIDAK menyegarkan ulang tiap kali tab hanya berpindah fokus (mis. buka
    // aplikasi lain lalu balik lagi) - itu memicu banyak percobaan berbarengan dan bisa
    // membuat kunci penyegaran "kepakai" oleh percobaan yang gagal. Cukup sekali saat
    // halaman ini benar-benar dimuat dari awal (lihat syncFromSession di atas).
    return () => {
