...
const TIMING = {
  ...
  boot: { ok: 3300, out: 3650, done: 4100 }, // saat aplikasi pertama dibuka
...
function LoginGate({ loading, onLogin }: { loading: boolean; onLogin: () => void }) {
  return (
    <div className="pt-shell">
      <main className="pt-main" style={{ paddingTop: "16vh" }}>
        <section className="pt-card pt-form-card" style={{ textAlign: "center" }}>
          ...
          <h2 className="pt-form-title" style={{ marginTop: 12 }}>
            HIGH STATE PD
          </h2>
          <p className="pt-muted" style={{ marginTop: 8 }}>
            {loading
  ...
  if (authState !== "in") {
    return (
      <div className="pt-root">
        <style>{css}</style>
        <LoginGate loading={authState === "loading"} onLogin={handleDiscordLogin} />
      </div>
    );
  }
